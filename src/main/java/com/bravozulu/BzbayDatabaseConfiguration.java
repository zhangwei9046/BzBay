 ...
 */
public class BzbayDatabaseConfiguration implements DatabaseConfiguration {
    final static Logger LOGGER = LoggerFactory.getLogger(BzbayDatabaseConfiguration.class);
